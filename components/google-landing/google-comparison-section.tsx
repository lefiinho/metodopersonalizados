...
export default function GoogleComparisonSection() {
  return (
    <section className="bg-[#FDF1F2] py-12 px-4">
      <div className="max-w-3xl mx-auto flex flex-col gap-8">
        <h2 className="reveal font-heading text-[25px] md:text-[30px] font-extrabold text-[#202B40] text-center text-balance">
          Você não precisa montar uma papelaria antes de atender o primeiro pedido.
        </h2>

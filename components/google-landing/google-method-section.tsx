...
export default function GoogleMethodSection() {
  return (
    <section id="conteudo" className="scroll-mt-20 md:scroll-mt-24 bg-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-3">
          <h2 className="reveal font-heading text-2xl md:text-3xl font-extrabold text-[#202B40] mb-3 text-balance">
            O que você vai aprender no Método Personalizados por Encomenda™
          </h2>
          <p className="font-sans text-[#535B68] text-sm md:text-base max-w-2xl mx-auto">
            Um caminho para criar, personalizar, divulgar, atender e entregar produtos por encomenda.
          </p>
        </div>
        ...
        <p className="reveal font-sans text-[#535B68] text-sm md:text-base text-center mt-6">
          O método também inclui aula de Fotos Ímã de Geladeira.
        </p>
      </div>
    </section>
  )
